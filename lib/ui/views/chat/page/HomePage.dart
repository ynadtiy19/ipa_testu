...
import 'package:my_first_app/services/components/QuestionInput.dart';
import 'package:my_first_app/stores/AIChatStore.dart';
import 'package:my_first_app/ui/utils/Chatgpt.dart';
import 'package:my_first_app/ui/utils/Time.dart';
import 'package:my_first_app/ui/utils/Utils.dart';
import 'package:my_first_app/ui/views/chat/page/ChatHistoryPage.dart';
import 'package:my_first_app/ui/views/chat/page/ChatPage.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          // 在左侧添加按钮
          icon: Icon(LineIcons.apple), // 返回图标
          onPressed: () {
